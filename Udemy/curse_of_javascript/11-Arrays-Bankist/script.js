...
btnTransfer.addEventListener('click', function (e) {
  ...
  inputTransferTo.value = inputLoanAmount.value = '';
  if (
    amount > 0 &&
...
btnClose.addEventListener('click', function (e) {
  ...
  if (
    closeAcc === currentAccount.username &&
...
// JS identifica "_" como uma variável descartável
...
/*
const movementsSch = [200, 450, -400, 3000, -650, -130, 70, 1300];
...
const movementsDescriptions = movements.map(
  ...
  // Don't use IF ELSE, method old-fashioned
);
...
Don't use "for" if you can use map,filter etc... is a functional code
const depositsFor = [];
...
// this method returns the first element not a new array
